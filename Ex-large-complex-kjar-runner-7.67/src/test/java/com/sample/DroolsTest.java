...
public class DroolsTest {
    ...
    public void testKjar() {
        ...
        ReleaseId releaseId = ks.newReleaseId("com.sample", "large-complex-kjar-767", "1.0.0");
        ...
        kBase.getKiePackages().forEach(pkg -> System.out.println("pkg.getRules().size() : " + pkg.getRules().size()));
