...
public class CreateContainerWithRestFullWarmup {
    ...
    public static void main(String[] args) {
        ...
        resource.addConfigItem(new KieServerConfigItem("org.example.kie.server.warmup.strategy", "rest-full", String.class.getName()));
