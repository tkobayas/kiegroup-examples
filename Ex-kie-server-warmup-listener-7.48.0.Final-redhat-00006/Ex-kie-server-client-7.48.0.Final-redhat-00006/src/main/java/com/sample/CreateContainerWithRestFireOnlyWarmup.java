...
public class CreateContainerWithRestFireOnlyWarmup {
    ...
    public static void main(String[] args) {
        ...
        resource.addConfigItem(new KieServerConfigItem("org.example.kie.server.warmup.strategy", "rest-fire-only", String.class.getName()));
